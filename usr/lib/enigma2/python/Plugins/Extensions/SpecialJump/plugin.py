...
class SpecialJumpEventTracker(Screen):
	...
	def serviceChanged_delayed(self):
		...
		if self.parent is not None:
			...
			#  File "/usr/lib/enigma2/python/Plugins/Extensions/SpecialJump/plugin.py", line 348, in serviceChanged_delayed
			#    self.parent.checkSetNewVolumeOnChange()
			#  File "/usr/lib/enigma2/python/Plugins/Extensions/SpecialJump/plugin.py", line 1104, in checkSetNewVolumeOnChange
			#    if InfoBar and self.InfoBar_instance:
			#AttributeError: SpecialJump instance has no attribute 'InfoBar_instance'
			
			# --> "self.InfoBar_instance = None" first!!
